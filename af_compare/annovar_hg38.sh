...
config=/staging/biology/u4432941/dragen_joint_calling/af_compare/ch_list
INPUT=/staging/reserve/paylong_ntu/AI_SHARE/Annotation/TWB_BenchMark/hs38DH/TWB1492_VCF_hs38DH.vqsr_SNP_INDEL_woGT.hc.recaled.vcf.gz
...
wkdir="/staging/biology/u4432941/dragen_joint_calling/af_compare/redo_sentieon"
...
bgzip sentieon_chr1_1.hg38_multianno.vcf
bgzip sentieon_chr1_2.hg38_multianno.vcf 

bcftools concat \
	--naive \
	-f file.list \
	-Ov -o sentieon_chr1.hg38_multianno.vcf
